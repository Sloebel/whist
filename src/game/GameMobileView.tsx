...
export default class GameMobileView extends Component<GameMobileViewProps> {
	private carouselEl: HTMLDivElement | null = null;
	private unListenSwipedLeft?: () => void;
	private unListenSwipedRight?: () => void;

	constructor(props: GameMobileViewProps) {
		super(props);
